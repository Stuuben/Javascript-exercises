...
for(let i1 = 0; i1 < alienPack.length; i1++){
    ...
    aName.innerHTML = alienPack[i1].aName;
    skincolor.innerHTML = alienPack[i1].skincolor;
    age.innerHTML = alienPack[i1].age;
    planet.innerHTML = alienPack[i1].planet;
...
//# sourceMappingURL=lordag.ee931cd1.js.map
